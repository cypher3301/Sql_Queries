...
# select BillingCountry, InvoiceId /*count(*) as 'number of invoice'*/
# from invoice
# where BillingCountry like 'argentina';
...
select EmployeeId, employee.LastName, employee.FirstName, Title, sum(Total),  i.*
from employee
